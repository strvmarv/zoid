    ...
    let provider_model = Section {
        ...
        rows: vec![
            FieldRow { label: "provider", value: cfg.provider.clone(),
                ...
                source: prov.provider, env_shadowed: prov.provider == Source::Env },
            ...
            FieldRow { label: "base_url", value: cfg.base_url.clone().unwrap_or_default(),
                kind: FieldKind::Text, source: prov.base_url,
...
mod tests {
    ...
    fn builds_four_sections_with_env_shadow() {
        ...
        let prov = Provenance {
            ...
            context_ceiling: Source::Default, auto_evict_cold: Source::Env,
        ...
        let auto_evict_row = economy.rows.iter().find(|r| r.label == "auto-evict cold").unwrap();
