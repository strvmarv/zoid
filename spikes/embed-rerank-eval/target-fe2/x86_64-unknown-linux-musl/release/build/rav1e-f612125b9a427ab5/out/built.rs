...
#[allow(dead_code)]
pub static TARGET: &str = "x86_64-unknown-linux-musl";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(dead_code)]
pub static RUSTC: &str = "/usr/local/rustup/toolchains/1.96.1-x86_64-unknown-linux-gnu/bin/rustc";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/usr/local/rustup/toolchains/1.96.1-x86_64-unknown-linux-gnu/bin/rustdoc";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/usr/local/rustup/toolchains/1.96.1-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.96.1 (31fca3adb 2026-06-26)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/usr/local/rustup/toolchains/1.96.1-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/usr/local/rustup/toolchains/1.96.1-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.96.1 (31fca3adb 2026-06-26)";
#[allow(clippy::needless_raw_string_hashes)]
